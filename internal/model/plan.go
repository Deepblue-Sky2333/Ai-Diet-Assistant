...
type Plan struct {
	...
	AIReasoning string        `json:"ai_reasoning,omitempty" db:"ai_reasoning" binding:"max=1000"`
...
type GeneratePlanRequest struct {
	Days        int    `json:"days" binding:"omitempty,min=1,max=7"`
	Preferences string `json:"preferences,omitempty" binding:"max=500"`
}
